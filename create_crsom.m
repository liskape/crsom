function [ som ] = create_crsom(inputs, targets, LR2, s_0, s_end)
    ...
    som.userdata = struct('context_net', context_net2(ones(nodes_size*nodes_size,1), ones(r_tar,1)), 'targets', targets, 'errors', [], 'net_name', '', 'max_adjusts', [], 'history_snaps', [], 'lr2', LR2, 's_0', s_0, 's_end', s_end);
