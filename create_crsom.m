...
%     som.trainParam.epochs = 100;
    ...
    som.userdata = struct('targets', targets, 'enable_snapping', true, 'store_errors', true,'enable_logging', false, 'computing_details', true, 'errors', [], 'net_name', '', 'mean_adjusts', [], 'history_snaps', [], 'context_snaps', [], 'snapped_epochs', [], 'lr2', LR2, 's_0', s_0, 's_end', s_end, 'mean_O_h', [], 'first_part', [],'second_part', [], 'observed_delta_h', [], 'observed_koefs', []);
